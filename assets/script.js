...
// create a function to fetch the 5-day forecast data from the API
...
function displayForecastData(forecastData) {
  ...
  // Loop through the forecast data and create HTML elements for each forecast item
  forecastData.list.forEach(forecast => {
    ...
    dateElement.textContent = `${date.toLocaleDateString()} ${time}`;
